	...
	$.bookshelfSlider = function(selector, settings) {
		...
		$(selector + ' .product').each(function(i) {
			...
			if (has_title && $bsc.product_show_title) {
				...
				the_title.css({ color: $bsc.product_title_textcolor, background: $bsc.product_title_bgcolor + ' url(assets/title_product_bg.png) repeat' });
			}
			...
			if (data_type == 'book') {
				$prod.append("<img class='fx_book' id='b_" + i + "' + src='assets/book_fx.png' />");
				...
				$prod.append("<img class='fx_magazine' id='m_" + i + "' + src='assets/magazine_fx.png' />");
				...
				$prod.append("<img class='fx_cd' id='cd_" + i + "' + src='assets/cd_fx.png' />");
				...
				$prod.append("<img class='fx_cd' id='dvd_" + i + "' + src='assets/dvd_fx.png' />");
			...
			//add shadow
			$prod.append("<img class='fx_shadow' id='shd_" + i + "' + src='assets/shadow_fx.png' />");
		...
		$(selector + ' .product').click(function(e) {
			...
			$('#popup_info').append("<img id='preload_icon' src='assets/preload.gif' />");
